  ...
  return (
    <div className='mt-4 ml-4 mr-4 flex flex-col gap-3 sm:flex-row' >
        <div className='flex gap-3 sm:w-full sm:pl-8'>
            <Link href='/categories/electronics' className='relative h-64 bg-[url("/images/electronics.png")] bg-cover w-full sm:h-96 border-2 transition duration-500 ease-in-out transform hover:border-black'>
            ...
            <Link href='/categories/jewelery' className='relative h-64 bg-[url("/images/jewelery.png")] bg-cover w-full sm:h-96 sm:w-2/3 border-2 transition duration-500 ease-in-out transform hover:border-black'>
              <div className='bg-black opacity-30 transition duration-500 ease-in-out transform hover:opacity-5 w-full h-full'></div>
